...
use "${flint}\data\student_level_all_2014_2024_05_24.dta", clear
...
collapse (rawsum) obs* (firstnm) sample_55 sample_27 (mean) frac_tested_trad frac_tested_all flag_resdcode charter female white black hisp poor speddummy lep samebcode_prioryear samedcode_prioryear mean_ach literacy numeracy frac_attend3 frac_attend3_new suspended chronic_abs, by(residentlea_weight year) 
...
save "${flint}/data/mi_geodist_panel_dy_all_2014.dta", replace	
