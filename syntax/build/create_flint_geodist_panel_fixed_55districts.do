...
use "${flint}\data\student_level_fixed_55districts_2024_05_24.dta", clear

replace residentlea_weight=res_lea14  

***********************************************************************************
*************************************Step 2****************************************
*Merge w/fixed effects (froms student-level data) and collapse data (District, grade, year)
***********************************************************************************
***********************************************************************************
...
save "${flint}/data/mi_geodist_panel_dy_fixed_55districts.dta", replace	
