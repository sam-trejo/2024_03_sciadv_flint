...
***********************************************************************************
*************************************Step 1****************************************
*Create a set of all districts based on ses and student enrollment 
***********************************************************************************
***********************************************************************************
...
save "${flint}\data\temp\residentlea_all_2014.dta", replace

***********************************************************************************
*************************************Step 2****************************************
*Creating a master list of rics based on all districts that we want to examine.
...
merge m:1 residentlea_weight using "${flint}\data\temp\residentlea_all_2014.dta"
keep if grade_fnl < 13 & year >= 2003
keep if _merge == 3
keep ric
gduplicates drop

save "${flint}\data\temp\rics_all_2014.dta", replace

***********************************************************************************
*************************************Step 3****************************************
*Creating a basic demographic file with student-level information based on the
*rics that lived in any residential LEA that we created above.
***********************************************************************************
***********************************************************************************
...
merge m:1 ric using "${flint}\data\temp\rics_all_2014.dta"
keep if _merge == 3
drop _merge
...
save "${flint}\data\temp\srds_all_2014.dta", replace

***********************************************************************************
*************************************Step 4****************************************
*Creating the assessment file based on the rics that lived in any residential 
*LEA that we created above.
***********************************************************************************
***********************************************************************************
...
save "${flint}\data\temp\assessment_all_2014.dta", replace
...
use "${flint}\data\temp\srds_all_2014.dta" 
...
merge 1:1 ric year using "${flint}\data\temp\assessment_all_2014.dta"
drop _merge
merge 1:1 ric year using "${flint}\data\temp\srds_all_2014.dta"
keep if _merge == 3
drop _merge
...
save "${flint}\data\temp\databeforeflags_all.dta", replace
...
***********************************************************************************
***********************************************************************************
use "${flint}\data\temp\databeforeflags_all.dta", clear
...
save "${flint}\data\student_level_all_2014.dta", replace
